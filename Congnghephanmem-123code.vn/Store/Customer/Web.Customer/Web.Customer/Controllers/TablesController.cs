...
namespace Web.Customer.Controllers
{
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idTable,name,status")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idTable,name,status")] Table table)
        {
            if (id != table.idTable)
            {
                return NotFound();
